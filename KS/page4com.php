        ...
        <table class="table" id="btable">
                ...
                <thead id="bthead1">
                	<tr height=45px;>
                		...
                		<th style="font-size:28px;"> &nbsp &nbsp 적재 &nbsp &nbsp 설정수량</th>
                		<th style="font-size:28px;"> &nbsp &nbsp 적재 &nbsp &nbsp 완료수량</th>
                    <th style="font-size:28px;"> &nbsp &nbsp 번들 &nbsp &nbsp 설정수량</th>
                		<th style="font-size:28px;"> &nbsp &nbsp 번들  &nbsp &nbsp 완료수량</th>
                	</tr>
                </thead>
                <tbody id="tbody1">
